...
-Charakter: vom User bestimmt(später KI Analyse)
-Lore:


Greedy(Filialleiter):
Eigenschaften: 51 Jahre alt
-Charakter: Geld, gierig, arrogant, hinterlistig, zielstrebig
-Lore: Hatte schon als Kind den Traum, ein großer Unternehmer zu werden und durch harte Arbeit ein Vermögen aufzubauen.
       ...
       ging bereicherten und die, die die Befehle ausführten und sich ausbeuten ließen, weil sie von den Ausbeutern 
       abhängig waren. Damit hatte sich sein Kindheitstraum verändert, denn nun wusste er, wo sein Vermögen herkommen 
       ...
       greifen nahe. Eines Tages kam der Filialleiter zu ihm und sagte: "Ich werde morgen den Tag über weg sein und du
       ...
       Tag kam er wieder und wartete, doch der Filialleiter blieb verschwunden. Am Morgen des dritten Tages wollte er gerade
       ...
       Er wird nicht mehr auftauchen. Es gab da ein paar Differenzen zwischen seiner Art diesen Laden zu führen und der Art meines 
       ...
       dem Filialleiter passiert war. Aber er wusste auch, dass mit ihm das Gleiche passieren würde, wenn er nicht alles tun würde, 
       ...
       Filialleiters und ein Zettel mit der Aufschrift: "Sie wurden soeben befördert und sind nun Teil unserer Organisation. 
       ...
       denen er sich erfreute war, wenn er seine Mitarbeiter ausbeuten konnte, um sich an ihnen zu bereichern.
